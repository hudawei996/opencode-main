...
export const commands = {
  ...
  notify: (title: string, description: string | null, href: string | null) =>
    __TAURI_INVOKE<null>("notify", { title, description, href }),
...
export const events = {
  ...
  notificationClick: makeEvent<NotificationClick>("notification-click"),
