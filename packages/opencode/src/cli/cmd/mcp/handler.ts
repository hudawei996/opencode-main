...
export async function authHandler(args: { name?: string }) {
  await Instance.provide({
    directory: process.cwd(),
    async fn() {
      UI.empty()
...
export async function authListHandler() {
  await Instance.provide({
    directory: process.cwd(),
    async fn() {
      UI.empty()
...
export async function logoutHandler(args: { name?: string }) {
  await Instance.provide({
    directory: process.cwd(),
    async fn() {
      UI.empty()
...
export async function debugHandler(args: { name: string }) {
  await Instance.provide({
    directory: process.cwd(),
    async fn() {
      UI.empty()
