...
| [awesome-opencode](https://github.com/weisser-dev/awesome-opencode) | 108 agents, 15 skills, smart model config, and interactive CLI setup (`npx @weisser-dev/awesome-opencode`) |
