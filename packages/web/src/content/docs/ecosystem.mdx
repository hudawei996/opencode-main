...
| [kibi-opencode](https://github.com/Looted/kibi/tree/main/packages/opencode)                        | OpenCode plugin for Kibi - repo-local, per-branch, queryable knowledge base with traceability     |
