...
| [opencode-toon-config-plugin](https://github.com/mmynsted/opencode-toon-config-plugin)             | Use AGENTS.toon, TOON based AGENTS file when possible over AGENTS.md for OpenCode agent direction.|
