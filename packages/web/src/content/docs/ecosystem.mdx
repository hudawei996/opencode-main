...
| [opencode-shell-commands](https://github.com/lucleray/opencode-shell-commands)                     | Define custom OpenCode commands that run directly in shell, skipping the LLM. Useful for defining quick commands for opening your workspace in VS Code, running `git checkout main`, and more |
