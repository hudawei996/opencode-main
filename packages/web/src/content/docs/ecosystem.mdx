...
| [@devtheops/opencode-plugin-otel](https://github.com/DEVtheOPS/opencode-plugin-otel)               | A plugin that exports telemetry via OpenTelemetry (OTLP/gRPC), mirroring the same signals as Claude Code's monitoring. |
