...
| [opencode-js-bounty](https://github.com/spxios/opencode-js-bounty-hunter)                          | Automated Bug Bounty tracking UI that extracts API endpoints and secrets from JS bundles          |
