...
| [opencode-chromium-browser-plugin](https://github.com/DJOCKER-FACE/opencode-chromium-browser-plugin) | Browser automation for Chromium browsers via a readable extension and native messaging host       |
